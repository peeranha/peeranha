...
const {
	wait, getBalance, getInt, createPeerenhaAndTokenContract, getHashContainer, getUserReward , periodUserReward, PeriodTime, fraction, setRetingOnePeriod, ratingChanges, ratingChangesInOneperiod, ratingChangesSkipPeriod, poolToken,
} = require('./utils');
...
describe("Test wallet", function () {
	...
	describe("Test add rating to reward", function () {
		...
		// for (const {actions, ratings, result, periodRewards} of ratingChangesInOneperiod) {
