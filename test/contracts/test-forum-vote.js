...
// 	// 		await peeranha.connect(signers[1]).createUser(hashContainer[0]);
// 	// 		await peeranha.createUser(hashContainer[1]);
// 	// 		await peeranha.addUserRating(signers[1].address, 40, 1);
// 	// 		await peeranha.createCommunity(ipfsHashes[0], createTags(5));
...
// 			await expect(userActionRating2).to.equal(userActionRating + AcceptedExpertReply);
...
// 			await expect(userActionRating2 ).to.equal(userActionRating + AcceptedCommonReply);
...
// 	// 		await expect(userRating).to.equal(userRating);
...
// 	// 		const user = await peeranha.getUserByAddress(signers[1].address);
// 	// 		const userAction = await peeranha.getUserByAddress(peeranha.deployTransaction.from);		
// 	// 		await expect(userRating).to.equal(userRating + UpvotedExpertReply);
// 	// 		await expect(userAction.rating).to.equal(userActionRating.rating);
...
// 	// 		const user = await peeranha.getUserByAddress(signers[1].address);
// 	// 		const userAction = await peeranha.getUserByAddress(peeranha.deployTransaction.from);		
// 	// 		await expect(userRating).to.equal(userRating + UpvotedCommonReply);
// 	// 		await expect(userAction.rating).to.equal(userActionRating.rating);
...
// 	// 		const user = await peeranha.getUserByAddress(signers[1].address);
// 	// 		const userAction = await peeranha.getUserByAddress(peeranha.deployTransaction.from);		
// 	// 		await expect(userRating).to.equal(userRating + AcceptExpertReply);
...
// 	// 		const user = await peeranha.getUserByAddress(signers[1].address);
// 	// 		const userAction = await peeranha.getUserByAddress(peeranha.deployTransaction.from);		
// 	// 		await expect(userRating).to.equal(userRating + AcceptCommonReply);
...
// 	// 		const newUserRating = await peeranha.getUserByAddress(signers[1].address);
// 	// 		await expect(newUserRating).to.equal(userRating + DeleteOwnReply - (FirstExpertReply + QuickExpertReply));
// 	// 	});
...
// 	// 		const newUserRating = await peeranha.getUserByAddress(signers[1].address);
// 	// 		await expect(newUserRating).to.equal(userRating + DeleteOwnReply - (FirstCommonReply + QuickCommonReply));
// 	// 	});
...
// 	// 		await peeranha.connect(signers[1]).createPost(1, hashContainer[0], PostTypeEnum.ExpertPost, [1]);		/// 1
// 	// 		await peeranha.createReply(1, 0, hashContainer[1], false);												///  1
// 			await peeranha.connect(signers[1]).createUser(hashContainer[0]);										//// merge change start
// 			await peeranha.connect(signers[2]).createUser(hashContainer[0]);
// 			await peeranha.createUser(hashContainer[1]);
// 			await peeranha.createCommunity(ipfsHashes[0], createTags(5));
...
// 			await peeranha.voteItem(1, 0, 0, 1);
// 			await peeranha.connect(signers[2]).voteItem(1, 0, 0, 1);
...
// 			await peeranha.voteItem(1, 1, 0, 1);
// 			await peeranha.connect(signers[2]).voteItem(1, 1, 0, 1);
...
// 	// 		await expect(peeranha.changePostType(1, PostTypeEnum.ExpertPost))
