...
describe("Test users", function() {
  ...
  it("Test user editing", async function() {
    ...
    await peeranhaUser.updateUser(peeranhaUser.deployTransaction.from, hashContainer[1]);
  ...
  xit("Test user editing/ non-existent user", async function() { // to do
    ...
    await expect(peeranhaUser.updateUser(peeranhaUser.deployTransaction.from, hashContainer[0]))
  ...
  xit("Test user editing, negative rating", async function() {
    ...
    await expect(peeranhaUser.connect(signers[1]).updateUser(signers[1].address, hashContainer[1])).to.be.revertedWith('low_rating_edit_profile');
  })
  ...
  it("Double follow community", async function() {
    ...
    await peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 1);
    await expect(peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 1)).to.be.revertedWith('already_followed');
  })
  ...
  it("Follow on not exist community", async function() {
    ...
    await expect(peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 1)).to.be.revertedWith('Community does not exist');
  ...
  it("Follow on freaze community", async function() {
    ...
    await expect(peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 1)).to.be.revertedWith('Community is frozen');
  })
  ...
  it("Follow on deferent communities", async function() {
    ...
    await peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 1);
    await peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 2);
  ...
  it("Follow on deferent communities -> unfollow from first -> follow on second community", async function() {
    ...
    await peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 1);
    await peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 2);
    await peeranhaUser.unfollowCommunity(peeranhaUser.deployTransaction.from, 1);
    await expect(peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 2)).to.be.revertedWith('already_followed');
  })
  ...
  it("Follow on two communities -> unfollow from first -> follow on third community", async function() {
    ...
    await peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 3);
  ...
  it("UnFollow diferent community", async function() {
    ...
    await peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 2);
    await peeranhaUser.unfollowCommunity(peeranhaUser.deployTransaction.from, 1);
    await peeranhaUser.unfollowCommunity(peeranhaUser.deployTransaction.from, 2);
  ...
  it("Double unFollow community", async function() {
    ...
    await peeranhaUser.followCommunity(peeranhaUser.deployTransaction.from, 1);
    await peeranhaUser.unfollowCommunity(peeranhaUser.deployTransaction.from, 1);
    await expect(peeranhaUser.unfollowCommunity(peeranhaUser.deployTransaction.from, 1)).to.be.revertedWith('comm_not_followed');
  })
