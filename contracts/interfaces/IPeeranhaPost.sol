...
interface IPeeranhaPost {
    function createPost(address name, uint8 communityId, bytes32 ipfsHash/*, CommunityLib.Tag[] memory tags*/) external;
    ...
    function editPost(address name, uint32 postId, uint8 communityId, bytes32 ipfsHash/*, CommunityLib.Tag[] memory tags*/) external;
    ...
    function voteItem(address name, uint32 postId, uint16[] memory path, uint16 replyId, uint8 commentId, bool isUpvote) external;
}