...
interface ICommunityTokenRewardFactory {
    ...
    function getUserCommunityRewardGraph(address userAddress, uint16 period, uint32 communityId, address communityTokenContractAddress) external view returns(uint256 rating);
}