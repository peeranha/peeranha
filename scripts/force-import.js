...
const { USER_ADDRESS, COMMUNITY_ADDRESS, CONTENT_ADDRESS, NFT_ADDRESS, TOKEN_ADDRESS, COMMUNITY_TOKEN_FACTORY_ADDRESS, USERLIB_ADDRESS, POSTLIB_ADDRESS } = require('../env.json');
