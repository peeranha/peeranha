...
async function main() {
  ...
  const txObj = await peeranhaCommunityTokenFactory.createNewCommunityTokenReward("name", "symbol", 0x0000000000000000000000000000000000000000, 1000, 10, 1655251200);
